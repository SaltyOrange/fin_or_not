...
from inception2layer_net.net import inference
...
x, y_true, y, gap_w, pool5_7x7_s1, train_step, accuracy, saver = \
...
data_reader = DataReader(train_dataset_dir, batch_size=batch_size,
                         file_names=False, resize_to=(224, 224))

tf.add_to_collection('x', x)
tf.add_to_collection('y', y)

tf.add_to_collection('gap_w', gap_w)
tf.add_to_collection('pool5_7x7_s1', pool5_7x7_s1)
